...
def load_wide_resnet_50(return_nodes:dict=None, verbose =False, size=(3,224,224)):
    model = torch.hub.load('pytorch/vision:v0.10.0', 'wide_resnet50_2', Wide_ResNet50_2_Weights.IMAGENET1K_V1, force_reload=False, verbose=False) #weights=Wide_ResNet50_2_Weights.DEFAULT)
